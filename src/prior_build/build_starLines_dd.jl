...
@everywhere begin
    ...
    prior_dict["map2visit"] = prior_dir*"2023_08_31/map2visit_1indx.h5" # update for the new run
    prior_dict["map2star"] = prior_dir*"2023_09_26/map2star_1indx.h5" # update for the new run
