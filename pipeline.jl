...
@everywhere begin
    ...
    RV_err_step = 4
    DIB_pix_err_step = 4 # consider increasing to 4 (self consistency + LSF test)
    DIB_sig_err_step = 3
    ...
    prior_dict["runlists"] = prior_dir*"2024_03_05/inject_15273only_295/injection_input_lst_"
