...
@everywhere begin
    ...
    alpha = 1;
    f = h5open(prior_dir2*"2023_05_29/starLine_priors/APOGEE_stellar_kry_125_subpix_th22500.h5")
...
@everywhere begin
    function multi_spectra_batch(indsubset; out_dir="../outdir")
        ...
        if !isfile(savename)
            ...
            f = h5open(prior_dir2*"2023_05_29/starLine_priors/APOGEE_stellar_kry_125_subpix_"*lpad(adjfibindx,3,"0")*".h5")
